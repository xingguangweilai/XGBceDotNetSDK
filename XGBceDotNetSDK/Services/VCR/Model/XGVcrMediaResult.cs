...
namespace XGBceDotNetSDK.Services.VCR.Model
{
    ...
    /// 媒体审核结果
    /// </summary>
    public class XGVcrMediaResult
    {
        private string type;
        private List<XGVcrMediaResultItem> items;

        public XGVcrMediaResult()
        {
        }
        ...
        public List<XGVcrMediaResultItem> Items { get => items; set => items = value; }
