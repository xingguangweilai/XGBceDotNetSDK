...
namespace XGBceDotNetSDK.Services.VCR.Model
{
    ...
    /// 音频审核结果
    /// </summary>
    public class XGVcrAudioResult
    {
        private string type;
        private List<XGVcrAudioResultItem> items;

        public XGVcrAudioResult()
        {
        }
        ...
        public List<XGVcrAudioResultItem> Items { get => items; set => items = value; }
