...
namespace XGBceDotNetSDK.Services.YUQING.Model
{
    ...
    /// 舆情监测任务
    /// </summary>
    public class XGYuqingTaskModel
    {
    ...
    /// 获取检测任务列表响应类
    /// </summary>
    public class XGYuqingListTasksResponse:XGYuqingResponse
    {
        private int? usedKeywordNum;
        private int? totalKeywordNum;
        private string leftKeywordNum;
        private List<XGYuqingTaskModel> list;

        public XGYuqingListTasksResponse()
        {
        }
        ...
        /// 
        /// </summary>
        [JsonProperty(PropertyName = "usedKeywordNum", NullValueHandling = NullValueHandling.Ignore)]
        public int? UsedKeywordNum { get => usedKeywordNum; set => usedKeywordNum = value; }
        /// <summary>
        /// 任务id
        /// </summary>
        [JsonProperty(PropertyName = "totalKeywordNum", NullValueHandling = NullValueHandling.Ignore)]
        public int? TotalKeywordNum { get => totalKeywordNum; set => totalKeywordNum = value; }
        /// <summary>
        /// 任务id
        /// </summary>
        [JsonProperty(PropertyName = "leftKeywordNum", NullValueHandling = NullValueHandling.Ignore)]
        public string LeftKeywordNum { get => leftKeywordNum; set => leftKeywordNum = value; }
        /// <summary>
        /// 任务列表
        /// </summary>
