...
{
    public class XGLssTimestampWatermark
    {
        private string name;
    ...
    /// 查询时间戳水印列表响应类
    /// </summary>
    public class XGLssListTimestampWatermarksResponse:XGLssResponse
    {
        private List<XGLssTimestampWatermark> timestampWatermarks;
        public XGLssListTimestampWatermarksResponse()
        {
        }
        ...
        /// 水印模板列表
        /// </summary>
        [JsonProperty(PropertyName = "timestampWatermarks", NullValueHandling = NullValueHandling.Ignore)]
        public List<XGLssTimestampWatermark> TimestampWatermarks { get => timestampWatermarks; set => timestampWatermarks = value; }
